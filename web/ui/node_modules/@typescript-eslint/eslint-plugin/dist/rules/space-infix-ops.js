...
exports.default = util.createRule({
    ...
    create(context) {
        ...
        function checkForPropertyDefinitionAssignmentSpace(node) {
            var _a;
            const leftNode = sourceCode.getLastToken((_a = node.typeAnnotation) !== null && _a !== void 0 ? _a : node.key);
        ...
        function checkForTypeAliasAssignment(node) {
            var _a;
            const leftNode = sourceCode.getLastToken((_a = node.typeParameters) !== null && _a !== void 0 ? _a : node.id);
