...
function s(c) {
  ...
  let n = 0,
      t = 0,
      o = 0;
  if ("universal" == c.type) return {
    a: 0,
    b: 0,
    c: 0
  };
  if ("id" === c.type) n += 1;else if ("tag" === c.type) o += 1;else if ("class" === c.type) t += 1;else if ("attribute" === c.type) t += 1;else if (function (s) {
    return parser.isPseudoElement(s);
  }(c)) o += 1;else if (parser.isPseudoClass(c)) switch (c.value) {
    case ":-moz-any":
    case ":-webkit-any":
    case ":any":
    case ":has":
    ...
    case ":nth-last-child":
      {
        t += 1;
        const s = c.nodes[0].nodes.findIndex(e => "tag" === e.type && "of" === e.value);

        if (s > -1) {
          const i = [parser.selector({
            nodes: c.nodes[0].nodes.slice(s + 1),
            value: ""
          })];
          c.nodes.length > 1 && i.push(...c.nodes.slice(1));
          const l = a(i);
          n += l.a, t += l.b, o += l.c;
        }
      }
    ...
    default:
      t += 1;
  } else parser.isContainer(c) && c.nodes.length > 0 && c.nodes.forEach(e => {
    const a = s(e);
    n += a.a, t += a.b, o += a.c;
  });
  return {
...
function a(e) {
  ...
  return e.forEach(e => {
    const c = s(e);
    c.a > a.a ? a = c : c.a < a.a || (c.b > a.b ? a = c : c.b < a.b || c.c > a.c && (a = c));
  }), a;
}
...
var validAtrules = ['container', 'document', 'media', 'supports', 'layer'];
