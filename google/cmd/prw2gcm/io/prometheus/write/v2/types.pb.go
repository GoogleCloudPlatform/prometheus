...
func (x *Sample) GetCreatedTimestamp() int64 {
	if x != nil {
...
type Histogram struct {
	...
	// created_timestamp represents an optional created timestamp for the histogram sample,
	// in ms format. The created timestamp represents the time when the
	// histogram started counting (sometimes referred to as start timestamp), which
	// can increase the accuracy of certain processing and query semantics (e.g. rates).
	//
	// Note that some receivers might require created timestamps for certain metric
	// types; rejecting such samples within the Request as a result.
	...
	// Zero value means value not set. If you need to use exactly zero value for
	// the timestamp, use 1 millisecond before or after.
	CreatedTimestamp int64 `protobuf:"varint,17,opt,name=created_timestamp,json=createdTimestamp,proto3" json:"created_timestamp,omitempty"`
}
...
func (x *Histogram) GetCreatedTimestamp() int64 {
	if x != nil {
		return x.CreatedTimestamp
	}
	return 0
...
var file_io_prometheus_write_v2_types_proto_rawDesc = []byte{
	...
	0x73, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x04, 0x22, 0xc6, 0x02, 0x0a, 0x0a, 0x54, 0x69, 0x6d, 0x65,
	...
	0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x4a, 0x04, 0x08, 0x06, 0x10, 0x07,
	0x22, 0x5f, 0x0a, 0x08, 0x45, 0x78, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x72, 0x12, 0x1f, 0x0a, 0x0b,
	0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x5f, 0x72, 0x65, 0x66, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0d, 0x52, 0x0a, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x52, 0x65, 0x66, 0x73, 0x12, 0x14, 0x0a,
	...
	0x70, 0x22, 0x69, 0x0a, 0x06, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x76,
	...
	,
	...
	,
	...
	0x6e, 0x42, 0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x0d, 0x6e, 0x65, 0x67, 0x61, 0x74, 0x69, 0x76,
	...
	0x76, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x4f, 0x0a, 0x0e, 0x70, 0x6f, 0x73, 0x69,
	...
	,
